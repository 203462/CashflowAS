...
import Nav from "./Nav";
class ReporteCuentasCobrar extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ObjetoIndicadores: [],
      ...
      case 1:
        this.state.array.map((value, index) => {
          if (
            ...
            value.tipo_registro === "Cuentas por Cobrar"
          ) {
  ...
  render() {
    return (
      <div>
        ...
        <h1 className="text-center">Reporte cuentas por cobrar</h1>
...
export default ReporteCuentasCobrar;
